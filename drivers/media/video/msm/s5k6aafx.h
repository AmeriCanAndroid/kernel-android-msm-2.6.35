...
#if defined(CONFIG_MACH_SHOOTER) || defined(CONFIG_MACH_SHOOTERU) || defined(CONFIG_MACH_RIDER) || defined(CONFIG_MACH_HOLIDAY) || defined(CONFIG_MACH_VERDI_LTE) || defined(CONFIG_MACH_KINGDOM)
