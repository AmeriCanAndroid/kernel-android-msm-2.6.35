...
ifeq ($(CONFIG_MACH_SHOOTER),y)
zreladdr-y             := 0x48008000
params_phys-y            := 0x48000100
initrd_phys-y            := 0x49000000
else
ifeq ($(CONFIG_MACH_SHOOTERU),y)
zreladdr-y             := 0x48008000
params_phys-y            := 0x48000100
initrd_phys-y            := 0x49000000
else
ifeq ($(CONFIG_MACH_SHOOTER_K),y)
zreladdr-y             := 0x48008000
params_phys-y            := 0x48000100
initrd_phys-y            := 0x49000000
else
ifeq ($(CONFIG_MACH_RIDER),y)
zreladdr-y             := 0x48008000
params_phys-y            := 0x48000100
initrd_phys-y            := 0x49000000
else
...
ifeq ($(CONFIG_MACH_HOLIDAY),y)
zreladdr-y             := 0x48008000
params_phys-y            := 0x48000100
initrd_phys-y            := 0x49000000
else
ifeq ($(CONFIG_MACH_RUBY),y)
zreladdr-y             := 0x48008000
params_phys-y            := 0x48000100
initrd_phys-y            := 0x49000000
else
ifeq ($(CONFIG_MACH_VIGOR),y)
zreladdr-y             := 0x48808000
params_phys-y            := 0x48800100
initrd_phys-y            := 0x49800000
else
